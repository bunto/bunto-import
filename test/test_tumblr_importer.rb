  ...
  context "A Tumblr blog" do
    ...
    context "post" do
      ...
      should "have a hash with a valid name" do
        assert_equal("2013-07-06-bunto-test.html", @batch[0][:name])
      end
      ...
      should "have a hash with a valid title" do
        assert_equal("Bunto: Test", @batch[0][:header]['title'])
      end

      should "have a hash with valid tags" do
        assert_equal("bunto", @batch[0][:header]['tags'][0])
      end
      ...
      should "have a hash with a valid slug" do
        assert_equal("http://github.com/post/54759400073/bunto-test", @batch[0][:slug])
      end
    end
